...
| `run_production_collector.py` | Shared production service entry wrapper that runs the selected research, official-company or domestic-news collector once; it does not evaluate or refresh historical comparison reports |
