...
def build_profiles() -> list[SourceProfile]:
    ...
    profiles.append(
        SourceProfile(
            ...
            pipeline="价值目录采集 + 首页预览/OCR -> 规则优先决策 -> 薄卡；兼容 article_reviews",
    ...
    profiles.extend(
        [
            SourceProfile(
                ...
                runtime_shape="常驻 simple",
                pipeline="快讯采集 -> 事件去重 -> 统一决策审计；兼容 events/event_analyses",
            ...
            SourceProfile(
                ...
                runtime_shape="timer one-shot",
                pipeline="持仓新闻采集 -> 相关性复核 -> 统一决策审计；兼容 events/event_analyses",
            ...
            SourceProfile(
                ...
                runtime_shape="timer one-shot",
                pipeline="公告采集 -> 正式披露优先决策 -> 统一审计；兼容 events/event_analyses",
            ...
            SourceProfile(
                ...
                runtime_shape="timer one-shot",
                pipeline="研报适配器 -> 统一决策审计；兼容 events/event_analyses",
