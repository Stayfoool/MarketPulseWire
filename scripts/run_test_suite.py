...
CI_SAFE_TESTS = (
    ...
    "test_market_item.py",
    "test_market_cards.py",
    "test_market_canonical_reader.py",
    "test_market_normalization.py",
    "test_market_pipeline_convergence.py",
