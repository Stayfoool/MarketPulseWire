...
SETTING_GROUPS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "fields": [
            ...
            SettingField("WEB_EVIDENCE_API_KEY", "Provider API Key", "web_evidence", sensitive=True, help="Tavily/Brave 等搜索 API key；留空表示保留现有密钥。"),
            SettingField("WEB_EVIDENCE_MODE", "检索模式", "web_evidence", placeholder="realtime"),
            SettingField("WEB_EVIDENCE_MAX_QUERIES", "最大 query 数", "web_evidence", placeholder="5"),
            SettingField("WEB_EVIDENCE_MAX_RESULTS", "每个 query 结果数", "web_evidence", placeholder="4"),
            SettingField("WEB_EVIDENCE_LOOKBACK_DAYS", "旧闻回看天数", "web_evidence", placeholder="30"),
            SettingField("WEB_EVIDENCE_TIMEOUT_SECONDS", "检索超时秒数", "web_evidence", placeholder="12"),
            SettingField("WEB_EVIDENCE_FETCH_BODY", "抓取网页正文", "web_evidence", placeholder="0"),
            SettingField("WEB_EVIDENCE_TAVILY_SEARCH_DEPTH", "Tavily 深度", "web_evidence", placeholder="basic"),
            SettingField("WEB_EVIDENCE_TAVILY_TOPIC", "Tavily topic", "web_evidence", placeholder="news"),
        ],
    },
    {
        "id": "x",
