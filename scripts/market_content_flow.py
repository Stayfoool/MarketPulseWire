"""Unified decision and interpretation flow for article-like market content."""
...
def normalized_article_item(source: str, item: dict[str, Any]) -> NormalizedMarketItem:
    ...
    return item_from_article_mapping(
        ...
        collector=str(item.get("collector") or profile.get("fetcher") or "market_content_flow"),
