...
RULES: tuple[LLMRuleDefinition, ...] = (
    ...
    _rule(
        ...
        "holding",
        "持仓评级或目标价变化",
        push="受信投行对持仓作出新覆盖、评级上调或下调、目标价上调或下调，或者改变投资建议。",
        daily="受信投行维持或重申既有评级、目标价，或者只给当前观点而没有修订。",
        archive="只转述历史评级，或者无法验证机构、对象和动作。",
        required=("受信投行", "持仓对象", "评级、目标价或投资建议动作", "当前或修订时间"),
        exclusions=("历史转述", "未归因观点", "只描述市场已有看法"),
    ),
    _rule(
    ...
    _rule(
        ...
        "semiconductor_ai",
        "半导体或 AI 产业价格和供需变化",
        push="产业价格或供需出现明确重大变化，包括持续显著涨跌、创历史水平并延续、接近倍数变化、结构性短缺或过剩、方向反转，或者主要厂商明确提价和调整供给。",
        daily="存在新的价格或供需方向，但变化未达到重大，或者局部紧张尚无明确后果。",
        archive="股票、ETF 或板块行情，历史价格回顾，或者没有产业价格对象的泛涨价表述。",
        required=("产业对象", "价格或供需变化", "方向", "当前状态或预测期"),
        exclusions=("证券行情", "历史回顾", "没有产业对象"),
    ),
    _rule(
        "semiconductor_material_change",
        "semiconductor_ai",
        "半导体或 AI 产业实质变化",
        push="已发生、已确认或进入执行的产能、投资、订单、采购、部署、交付、平台产品或技术路线重大变化，并明确影响关注产业；首次确认向全球大厂供货。",
        daily="计划、预期、初步提案、谈判试用、无约束合作、概念发布，或者正式动工但没有投资额、产能、订单或明确采购。",
        archive="历史能力介绍、城市招商、供应名单传闻、一般生态合作、教程、工具更新或普通产品宣传。",
        required=("产业主体和对象", "产能、投资、订单、部署、产品或路线变化", "发生状态", "当前时间证据"),
        exclusions=("纯计划或预测", "无约束合作", "历史宣传", "证券行情"),
    ),
    _rule(
    ...
    _rule(
        ...
        "semiconductor_ai",
        "投行配置建议或动作变化",
        push="受信投行对关注个股或半导体、AI 主题作出新的明确做多做空、显著增配减配建议或动作，或者提出完整双向轮动并明确从什么转向什么。",
        daily="存在有方向的新观点，但配置建议或动作不够明确；或者维持既有建议。",
        archive="只描述市场当前仓位、客户或基金已经发生的资金流，没有该机构新的配置建议或动作，或者只是泛市场评论。",
        required=("受信投行", "关注个股或产业主题", "新的配置建议或动作", "方向和时间"),
        exclusions=("描述已有仓位", "客户或基金资金流", "泛市场评论"),
    ),
    _rule(
