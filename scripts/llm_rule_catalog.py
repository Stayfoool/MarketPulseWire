...
RULE_MATRIX_VERSION = "llm-reviewed-rule-matrix-v11-20260724"
CATALOG_VERSION = "llm-rule-catalog-v12"
...
RULES: tuple[LLMRuleDefinition, ...] = (
    ...
    _rule(
        ...
        push=(
            ...
            "正式订单、采购、约束性供货或首次确认向全球大厂供货；持仓公司当前正式公告回购本公司股份，"
            "或者收到控股股东、实际控制人、董事、监事、高级管理人员等正式提出的本公司股份回购提议；"
            "控股股东、实际控制人、一致行动人、董事、监事、高级管理人员或其他重要股东当前正式公告出售或"
            "减持该持仓公司股份。股份回购提议、回购计划、出售或减持计划本身即为push，不要求达到金额或比例阈值，"
            "也不要求已经实施；后续实施、完成、调整、终止或取消同样属于当前实质变化。"
        ),
        daily="普通经营更新；初步讨论或非约束性意向；正式动工但没有投资额、产能、订单或明确采购；其他客户首次确认供货或尚未执行的新进展。",
        archive="财报日期提醒、历史回顾、行情模板、程序性公告、能力宣传、供应名单传闻或普通框架合作。",
        required=(
            "持仓主体",
            "企业变化对象；股份交易还须局部绑定行为主体和该持仓公司自身股份",
