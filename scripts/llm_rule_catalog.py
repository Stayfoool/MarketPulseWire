...
RULE_MATRIX_VERSION = "llm-reviewed-rule-matrix-v2-20260723"
CATALOG_VERSION = "llm-rule-catalog-v3"
...
RULES: tuple[LLMRuleDefinition, ...] = (
    ...
    _rule(
        ...
        "semiconductor_ai",
        "半导体或 AI 产业实质变化",
        push="已发生、已确认或进入执行的产能、投资、订单、采购、部署、交付、平台产品或技术路线重大变化，并明确影响关注产业；或者具名重量级客户正在测试、验证、导入评估具体产品或平台，或明确考虑采用，可能打开新的客户、订单或增长空间。上述预期变化不要求已经形成批量订单、收入或交付。",
        daily="缺少重大量级的一般计划或预期；非重量级或匿名客户的早期接触；尚未进入具体测试、验证或采用评估的无约束合作、概念发布或产品宣传。",
        archive="历史能力介绍、城市招商、供应名单传闻、一般生态合作、教程、工具更新或普通产品宣传。",
        required=("产业主体和对象", "实质变化或重量级客户的具体评估动作", "当前阶段", "当前时间证据"),
        exclusions=("没有具体动作的泛计划", "无约束合作", "历史宣传", "证券行情"),
    ),
    _rule(
