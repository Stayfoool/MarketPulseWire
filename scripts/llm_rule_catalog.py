...
RULE_MATRIX_VERSION = "llm-reviewed-rule-matrix-v4-20260723"
CATALOG_VERSION = "llm-rule-catalog-v5"
...
RULES: tuple[LLMRuleDefinition, ...] = (
    ...
    _rule(
        ...
        push=(
            ...
            "计算的隐含涨跌幅大于等于30%或小于等于-30%。"
        ),
        daily=(
            "受信投行维持或重申既有评级、目标价，或只给当前观点而没有修订；"
            "或同一研报的目标价隐含涨跌幅绝对值低于30%且无其他修订。"
        ),
    ...
    _rule(
        ...
        push=(
            ...
            "带日期的历史收盘价，按“目标价/历史收盘价-1”计算的隐含涨跌幅大于等于30%或小于等于-30%。"
        ),
        daily=(
            "存在有方向的新观点，但配置建议或动作不够明确；或维持既有建议；"
            "或同一研报的个股目标价隐含涨跌幅绝对值低于30%且无其他配置动作。"
        ),
